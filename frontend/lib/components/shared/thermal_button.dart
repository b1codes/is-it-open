...
class _ThermalButtonState extends State<ThermalButton>
            ...
            AnimatedContainer(
              ...
              decoration: BoxDecoration(
                color: isEnabled
                    ...
                    : AppColors.inkWarmMuted.withValues(alpha: 0.5),
                      ...
                      builder: (context, child) {
                        return CustomPaint(
                          painter: _ThermalGlowPainter(
                            ...
                            opacity: (1.0 - _glowController.value).clamp(
                              0.0,
                              1.0,
                            ),
                            gradient:
                                effects?.thermalGlowGradient ??
                                const LinearGradient(
                                  colors: [
                                    AppColors.thermalCore,
                                    AppColors.thermalCorona,
                                  ],
                                ),
                          ),
                        );
